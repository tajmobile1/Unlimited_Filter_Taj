...
async def startCMD(client: FilterBot, message: Message):
    ...
    keyboard = [[
      ...
      InlineKeyboardButton('Update', url='t.me/technicaltaj'),
      InlineKeyboardButton('Support', url='t.me/technical_taj')
      ]]
...
async def aboutCMD(client: FilterBot, message: Message):
    ...
    keyboard = [[ InlineKeyboardButton('• Tutorial •', url='https://youtu.be/technicaltaj'),
                   InlineKeyboardButton('• Repo •', url='https://github.com/tajmobile1/Unlimited_Filter_Taj') ],
